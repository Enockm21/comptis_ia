...
const NAV = [
  ...
  { to: '/notes-frais', label: 'Notes de frais', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" stroke="currentColor" strokeWidth="2"/>
      <rect x="9" y="3" width="6" height="4" rx="1" stroke="currentColor" strokeWidth="2"/>
      <circle cx="12" cy="14" r="2" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M9 14h.01M15 14h.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  )},
  ...
  { to: '/factures', label: 'Factures OCR', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" stroke="currentColor" strokeWidth="2"/>
      <polyline points="14,2 14,8 20,8" stroke="currentColor" strokeWidth="2"/>
      <circle cx="11" cy="14" r="2" stroke="currentColor" strokeWidth="2"/>
      <path d="M16 19l-2.5-2.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  )},
