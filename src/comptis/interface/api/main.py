...
from comptis.interface.api.alertes.router import router as alertes_router
from comptis.interface.api.notes_frais.router import router as notes_frais_router
...
app.include_router(notes_frais_router)
